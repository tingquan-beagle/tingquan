...
void Joystick::controlCylinders() {
    ...
    if (is_left_manual_mode && is_right_manual_mode) {
        ...
        if (is_deadman_engaged) {
            ...
            // setRelay(1,HIGH)// gripper close
            // delay(5000);
            // setRelay(1,LOW);
            // setRelay(2,HIGH);// gripper open
            // delay(5000);
            // setRelay(2,LOW);
            // setRelay(3,HIGH);// control rotary cylinder
            // delay(5000);
            // setRelay(3,LOW);
            // setRelay(4,HIGH);// control horizontal cylinder
            // delay(5000);
            // setRelay(4,LOW);
            // setRelay(5,HIGH);// control second cutter
            // delay(5000);
            // setRelay(5,LOW);
            // delay(5000);
